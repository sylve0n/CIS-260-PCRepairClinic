...
<?php
	...
	print("<button class='btn waves-effect waves-light blue-grey' type='submit'>Search</button> &nbsp;");
	print("<input type='button' class='btn waves-effect waves-light blue-grey' onclick='resetForm()' value='Clear'><br>");
